...
Contributors to pyFAI license their code under the same license when it is
included into pyFAI's version control repository. That means contributors must
own the copyright of any code submitted to pyFAI or must include the MIT
