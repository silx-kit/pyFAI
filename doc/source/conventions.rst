:Author: Marco Cammarata, Jérôme Kieffer
:Date: 28/08/2026
...
There is a norm in photography for storing this kind of information in an EXIF tag as an integer with a value from 1 to 8::
    1        2       3       4         5            6           7          8
 o              o                 o                                              o
...
This differs in two point with pyFAI's definition:
...
The *orientation* is a property of the *detector*, it is **intentionally immutable** to prevent errors.
For now, only the geometries 1 to 4 are supported, the rotated geometries can easily be accommodated using the *rot3* parameter during the calibration of the experimental setup


Converting the calibration from *Dioptas* to process data with *pyFAI*
......................................................................

Despite *Diotas* uses the *pyFAI* library to perform the geometry calculation, refinement and PONI-file management, it offers the ability to actually flip/rotate the image
...
Since the images are flipped, the direction of the azimuthal angle cannot match and the **chi** will not only differ in numerical values but most importantly in direction.
...
For now, all detectors are initialized with the orientation (3), i.e. it does not change with the convention used in pyFAI since 2010.
