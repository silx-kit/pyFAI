# -*- coding: utf-8 -*-
#
# pyFAI documentation build configuration file, created by
...
project = u'pyFAI'
copyright = u'2012-2014, Jerome Kieffer'
...
texinfo_documents = [
  ('index', 'pyFAI', u'pyFAI Documentation',
   u'Jérôme Kieffer', 'pyFAI', 'One line description of project.',
   'Miscellaneous'),
]
