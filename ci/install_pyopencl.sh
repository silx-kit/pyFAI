...
CL_LIBRARY_PATH=${python3 -c "import os; print(os.environ['LD_LIBRARY_PATH'].split(':')[-1])"}
CL_INCLUDE_PATH=${python3 -c "import os; print(os.environ['C_INCLUDE_PATH'].split(':')[-1])"}
