...
out_ocl = gpu.integrate(data)#, dummy= -2, delta_dummy=1.5, solidAngle=ai.solidAngleArray(data.shape))
...
out_ocl = gpu.integrate(data, dummy= -2, delta_dummy=1.5)
...
out_ocl = gpu.integrate(data, dark=dark)
