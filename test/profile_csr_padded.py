...
ocl_csr = ocl_azim_csr.OCL_CSR_Integrator(cyt_lut.csr_data, cyt_lut.csr_indices, cyt_lut.csr_indptr, data.size, "GPU",profile=True, block_size=workgroup_size)
...
ocl_csr_padded = ocl_azim_csr.OCL_CSR_Integrator(cyt_lut.csr_padded_data, cyt_lut.csr_padded_indices, cyt_lut.csr_padded_indptr, data.size, "GPU",profile=True, padded=True, block_size=workgroup_size)
