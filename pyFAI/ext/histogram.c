 ...
 */
        ...
        if (1 == 0) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel private(__pyx_t_25, __pyx_t_23, __pyx_t_15, __pyx_t_22, __pyx_t_4, __pyx_t_26, __pyx_t_27, __pyx_t_24)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    #pragma omp for firstprivate(__pyx_v_i) lastprivate(__pyx_v_i) lastprivate(__pyx_v_fbin) lastprivate(__pyx_v_bin) lastprivate(__pyx_v_thread) lastprivate(__pyx_v_d) lastprivate(__pyx_v_a)
                    #endif /* _OPENMP */
 ...
 */
        ...
        if (1 == 0) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel private(__pyx_t_28, __pyx_t_35, __pyx_t_29, __pyx_t_4, __pyx_t_34, __pyx_t_33, __pyx_t_31, __pyx_t_36, __pyx_t_30, __pyx_t_32)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    #pragma omp for lastprivate(__pyx_v_tmp_count) firstprivate(__pyx_v_idx) lastprivate(__pyx_v_idx) lastprivate(__pyx_v_tmp_data) lastprivate(__pyx_v_thread)
                    #endif /* _OPENMP */
 ...
 */
        ...
        if (1 == 0) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel private(__pyx_t_40, __pyx_t_35, __pyx_t_41, __pyx_t_34, __pyx_t_33, __pyx_t_22, __pyx_t_37, __pyx_t_38, __pyx_t_42, __pyx_t_43, __pyx_t_36, __pyx_t_32, __pyx_t_39)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
