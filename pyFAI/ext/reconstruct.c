 ...
 */
  {
      ...
      /*try:*/ {
        ...
        if (1 == 0) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel private(__pyx_t_22, __pyx_t_18, __pyx_t_23, __pyx_t_20, __pyx_t_8, __pyx_t_21, __pyx_t_19)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
