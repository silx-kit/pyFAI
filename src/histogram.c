 ...
 */
        ...
        if (1 == 0) abort();
        {
            ...
            if (__pyx_t_19 > 0)
            {
                ...
                {
                    #ifdef _OPENMP
                    #pragma omp for lastprivate(__pyx_v_a) lastprivate(__pyx_v_bin) lastprivate(__pyx_v_dtmp) lastprivate(__pyx_v_dInt) lastprivate(__pyx_v_dest) firstprivate(__pyx_v_i) lastprivate(__pyx_v_i) lastprivate(__pyx_v_dIntR) lastprivate(__pyx_v_fbin) lastprivate(__pyx_v_dIntL) lastprivate(__pyx_v_ffbin) lastprivate(__pyx_v_d)
                    #endif /* _OPENMP */
 ...
 */
        ...
        if (1 == 0) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel private(__pyx_t_86, __pyx_t_83, __pyx_t_88, __pyx_t_87, __pyx_t_93, __pyx_t_89, __pyx_t_24, __pyx_t_84, __pyx_t_92, __pyx_t_85, __pyx_t_91, __pyx_t_94, __pyx_t_90)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
