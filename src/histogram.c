...
static char __pyx_k__20130711[] = "20130711";
 ...
 */
        ...
        if (1 == 0) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel private(__pyx_t_21, __pyx_t_16, __pyx_t_22, __pyx_t_14, __pyx_t_4, __pyx_t_20)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    #pragma omp for lastprivate(__pyx_v_ffbin) lastprivate(__pyx_v_dInt) lastprivate(__pyx_v_bin) lastprivate(__pyx_v_dest) lastprivate(__pyx_v_fbin) lastprivate(__pyx_v_a) lastprivate(__pyx_v_dtmp) firstprivate(__pyx_v_i) lastprivate(__pyx_v_i) lastprivate(__pyx_v_d) lastprivate(__pyx_v_dIntR) lastprivate(__pyx_v_dIntL)
                    #endif /* _OPENMP */
 ...
 */
        ...
        if (1 == 0) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel reduction(+:__pyx_v_tmp_data) reduction(+:__pyx_v_tmp_count) private(__pyx_t_25, __pyx_t_24, __pyx_t_17, __pyx_t_22, __pyx_t_23, __pyx_t_4, __pyx_t_26, __pyx_t_27)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
 ...
 */
        ...
        if (1 == 0) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel private(__pyx_t_81, __pyx_t_91, __pyx_t_90, __pyx_t_84, __pyx_t_82, __pyx_t_85, __pyx_t_89, __pyx_t_87, __pyx_t_88, __pyx_t_83, __pyx_t_86, __pyx_t_23, __pyx_t_80)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
