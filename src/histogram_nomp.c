/* Generated by Cython 0.19.1 on Fri Mar 20 14:10:05 2015 */
...
static char __pyx_k_59[] = "/users/kieffer/workspace-400/pyFAI/src/histogram.pyx";
 ...
 */
    ...
    if (values[6]) {
      __pyx_v_empty = __pyx_PyFloat_AsFloat(values[6]); if (unlikely((__pyx_v_empty == (float)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 63; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
 ...
 */
            ...
            *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_out_merge.rcbuffer->pybuffer.buf, __pyx_t_25, __pyx_pybuffernd_out_merge.diminfo[0].strides) = __pyx_v_empty;
          }
          __pyx_L13:;
        }
      }
 ...
 */
    ...
    __pyx_v_nthread = values[5];
    if (values[6]) {
      __pyx_v_empty = __pyx_PyFloat_AsFloat(values[6]); if (unlikely((__pyx_v_empty == (float)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 135; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
 ...
 */
              ...
              *__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_out_merge.rcbuffer->pybuffer.buf, __pyx_t_41, __pyx_pybuffernd_out_merge.diminfo[0].strides, __pyx_t_42, __pyx_pybuffernd_out_merge.diminfo[1].strides) = __pyx_v_empty;
            }
            __pyx_L28:;
          }
        }
