...
static PyMethodDef __pyx_mdef_5_blob_1local_max = {"local_max", (PyCFunction)__pyx_pw_5_blob_1local_max, METH_VARARGS|METH_KEYWORDS, __pyx_doc_5_blob_local_max};
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "_blob._memoryviewslice", /*tp_name*/
