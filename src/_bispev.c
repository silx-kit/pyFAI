/* Generated by Cython 0.19.1 on Mon Oct 20 16:25:57 2014 */
 ...
 */
        ...
        if (1 == 0) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel private(__pyx_t_17, __pyx_t_25, __pyx_t_16, __pyx_t_21, __pyx_t_24, __pyx_t_14, __pyx_t_19, __pyx_t_22, __pyx_t_15, __pyx_t_23, __pyx_t_13, __pyx_t_18, __pyx_t_20)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    #pragma omp for lastprivate(__pyx_v_i1) lastprivate(__pyx_v_tmp) lastprivate(__pyx_v_a) lastprivate(__pyx_v_l2) lastprivate(__pyx_v_i) lastprivate(__pyx_v_err) lastprivate(__pyx_v_sp) lastprivate(__pyx_v_j1) firstprivate(__pyx_v_j) lastprivate(__pyx_v_j)
                    #endif /* _OPENMP */
