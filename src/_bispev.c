...
static char __pyx_k_56[] = "05/03/2015";
 ...
 */
        ...
        if (1 == 0) abort();
        {
                ...
                #define unlikely(x) (x)
            #endif
            __pyx_t_12 = (__pyx_t_3 - 0) / 1;
            if (__pyx_t_12 > 0)
            {
                #ifdef _OPENMP
                #pragma omp parallel private(__pyx_t_14, __pyx_t_20, __pyx_t_22, __pyx_t_23, __pyx_t_25, __pyx_t_21, __pyx_t_19, __pyx_t_15, __pyx_t_17, __pyx_t_16, __pyx_t_13, __pyx_t_18, __pyx_t_24)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    #pragma omp for lastprivate(__pyx_v_tmp) lastprivate(__pyx_v_sp) lastprivate(__pyx_v_l2) lastprivate(__pyx_v_err) lastprivate(__pyx_v_i1) lastprivate(__pyx_v_a) firstprivate(__pyx_v_j) lastprivate(__pyx_v_j) lastprivate(__pyx_v_i) lastprivate(__pyx_v_j1)
                    #endif /* _OPENMP */
                    for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_12; __pyx_t_11++){
                        {
                            __pyx_v_j = 0 + 1 * __pyx_t_11;
 ...
 * 
 */
                              __pyx_t_15 = ((__pyx_v_j * __pyx_v_mx) + __pyx_v_i);
                              *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_z.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_z.diminfo[0].strides) += __pyx_v_sp;
                            }
                        }
                    }
                }
