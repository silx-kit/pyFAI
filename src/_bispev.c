 ...
 */
        ...
        if (1 == 0) abort();
        {
            ...
            if (__pyx_t_15 > 0)
            {
                ...
                {
                    #ifdef _OPENMP
                    #pragma omp for lastprivate(__pyx_v_j1) lastprivate(__pyx_v_i1) lastprivate(__pyx_v_err) lastprivate(__pyx_v_i) firstprivate(__pyx_v_j) lastprivate(__pyx_v_j) lastprivate(__pyx_v_l2) lastprivate(__pyx_v_a) lastprivate(__pyx_v_tmp) lastprivate(__pyx_v_sp)
                    #endif /* _OPENMP */
