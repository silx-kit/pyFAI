...
static PyMethodDef __pyx_mdef_7relabel_1countThem = {"countThem", (PyCFunction)__pyx_pw_7relabel_1countThem, METH_VARARGS|METH_KEYWORDS, __pyx_doc_7relabel_countThem};
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "relabel._memoryviewslice", /*tp_name*/
