/* Generated by Cython 0.19.1 on Mon Oct 20 16:29:12 2014 */
 ...
 */
        ...
        if (1 == 0) abort();
        {
            ...
            if (__pyx_t_21 > 0)
            {
                ...
                {
                    #ifdef _OPENMP
                    #pragma omp for firstprivate(__pyx_v_i) lastprivate(__pyx_v_i) lastprivate(__pyx_v_thread) lastprivate(__pyx_v_a) lastprivate(__pyx_v_fbin) lastprivate(__pyx_v_bin) lastprivate(__pyx_v_d)
                    #endif /* _OPENMP */
