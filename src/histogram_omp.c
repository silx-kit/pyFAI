/* Generated by Cython 0.20.1post0 (Debian 0.20.1+git90-g0e6e38e-1+b1) on Mon Nov 10 20:42:23 2014 */
 ...
 */
        ...
        if (1 == 0) abort();
        {
            ...
            if (__pyx_t_21 > 0)
            {
                ...
                {
                    #ifdef _OPENMP
                    #pragma omp for lastprivate(__pyx_v_bin) lastprivate(__pyx_v_d) lastprivate(__pyx_v_thread) lastprivate(__pyx_v_a) firstprivate(__pyx_v_i) lastprivate(__pyx_v_i) lastprivate(__pyx_v_fbin)
                    #endif /* _OPENMP */
