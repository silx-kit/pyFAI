...
static char __pyx_k_home_jerome_workspace_pyFAI_src[] = "/home/jerome/workspace/pyFAI/src/histogram.pyx";
 ...
 */
        ...
        if (1 == 0) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel private(__pyx_t_27, __pyx_t_15, __pyx_t_22, __pyx_t_23, __pyx_t_25, __pyx_t_4, __pyx_t_24, __pyx_t_26)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    #pragma omp for lastprivate(__pyx_v_bin) lastprivate(__pyx_v_d) lastprivate(__pyx_v_fbin) lastprivate(__pyx_v_thread) firstprivate(__pyx_v_i) lastprivate(__pyx_v_i) lastprivate(__pyx_v_a)
                    #endif /* _OPENMP */
 ...
 */
        ...
        if (1 == 0) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel private(__pyx_t_30, __pyx_t_35, __pyx_t_36, __pyx_t_34, __pyx_t_32, __pyx_t_28, __pyx_t_29, __pyx_t_4, __pyx_t_33, __pyx_t_31)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    #pragma omp for firstprivate(__pyx_v_idx) lastprivate(__pyx_v_idx) lastprivate(__pyx_v_thread) lastprivate(__pyx_v_tmp_data) lastprivate(__pyx_v_tmp_count)
                    #endif /* _OPENMP */
 ...
 */
        ...
        if (1 == 0) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel private(__pyx_t_39, __pyx_t_37, __pyx_t_38, __pyx_t_35, __pyx_t_36, __pyx_t_42, __pyx_t_34, __pyx_t_40, __pyx_t_32, __pyx_t_41, __pyx_t_22, __pyx_t_33, __pyx_t_43)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "src.histogram")) {
      if (unlikely(PyDict_SetItemString(modules, "src.histogram", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyNumber_Add(__pyx_float_1_0, __pyx_t_4); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[4]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
