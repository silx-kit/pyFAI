/* Generated by Cython 0.19.1 on Mon Sep 29 17:16:41 2014 */
...
static char __pyx_k_48[] = "29/09/2014";
 ...
 */
        ...
        if (1 == 0) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel private(__pyx_t_34, __pyx_t_26, __pyx_t_25, __pyx_t_16, __pyx_t_33, __pyx_t_36, __pyx_t_24, __pyx_t_27, __pyx_t_14, __pyx_t_28, __pyx_t_35, __pyx_t_23, __pyx_t_31, __pyx_t_30, __pyx_t_4, __pyx_t_32, __pyx_t_29)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    #pragma omp for lastprivate(__pyx_v_d) lastprivate(__pyx_v_thread) lastprivate(__pyx_v_dInt) lastprivate(__pyx_v_fbin) lastprivate(__pyx_v_dtmp) lastprivate(__pyx_v_a) lastprivate(__pyx_v_bin) lastprivate(__pyx_v_dIntL) lastprivate(__pyx_v_dIntR) firstprivate(__pyx_v_i) lastprivate(__pyx_v_i) lastprivate(__pyx_v_ffbin)
                    #endif /* _OPENMP */
 ...
 */
        ...
        if (1 == 0) abort();
        {
            ...
            if (__pyx_t_5 > 0)
            {
                ...
                {
                    #ifdef _OPENMP
                    #pragma omp for lastprivate(__pyx_v_thread) lastprivate(__pyx_v_tmp_data) firstprivate(__pyx_v_bin) lastprivate(__pyx_v_bin) lastprivate(__pyx_v_tmp_count)
                    #endif /* _OPENMP */
