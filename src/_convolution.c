 ...
 */
  {
      ...
      /*try:*/ {
        ...
        if (1 == 0) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel private(__pyx_t_14, __pyx_t_20, __pyx_t_1, __pyx_t_15, __pyx_t_17, __pyx_t_19, __pyx_t_16, __pyx_t_18)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    #pragma omp for lastprivate(__pyx_v_tmp) lastprivate(__pyx_v_err) lastprivate(__pyx_v_x) firstprivate(__pyx_v_y) lastprivate(__pyx_v_y) lastprivate(__pyx_v_newpos) lastprivate(__pyx_v_fIndex) lastprivate(__pyx_v_val) lastprivate(__pyx_v_sum)
                    #endif /* _OPENMP */
      ...
      /*try:*/ {
        ...
        if (1 == 0) abort();
        {
            ...
            if (__pyx_t_13 > 0)
            {
                ...
                {
                    #ifdef _OPENMP
                    #pragma omp for lastprivate(__pyx_v_newpos) lastprivate(__pyx_v_val) lastprivate(__pyx_v_tmp) firstprivate(__pyx_v_y) lastprivate(__pyx_v_y) lastprivate(__pyx_v_x) lastprivate(__pyx_v_sum) lastprivate(__pyx_v_fIndex) lastprivate(__pyx_v_err)
                    #endif /* _OPENMP */
                    for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_13; __pyx_t_12++){
                        {
                            __pyx_v_y = 0 + 1 * __pyx_t_12;
